...
(0, _utilsJs.preloadFonts)("qsy7khk").then(()=>{
    ...
    [
        ...
        new (0, _itemJs.Item)(element);
    });
});

},{"./utils.js":"72Dku","./item.js":"8aqVM"}],"8aqVM":[function(require,module,exports) {
...
class Item {
     ...
     */ constructor(DOM_el){
        ...
        }, 0)// Also scale up the image element
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["5oY9T","30wP2"], "30wP2", "parcelRequire2524")
